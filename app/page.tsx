...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section with 3D Element - Full Screen */}
      <section className="h-[calc(100vh-73px)] max-w-7xl mx-auto px-6 flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
          {/* Left Content */}
          <div className="space-y-10">
            <h1 className="text-6xl lg:text-7xl font-normal text-gray-900 leading-tight">
              Evaluate your AI agents
              <span className="text-[#4285F4] font-medium"> with confidence</span>
            </h1>
            ...
            <div className="flex gap-4 pt-6">
              <Link
                href="/auth/signup"
                className="px-10 py-4 bg-[#4285F4] text-white rounded-lg hover:bg-[#1967D2] font-medium text-base transition shadow-md"
              >
                Start free trial
              </Link>
              <Link
                href="#features"
                className="px-10 py-4 border-2 border-gray-300 text-gray-700 rounded-lg hover:border-[#4285F4] hover:text-[#4285F4] font-medium text-base transition"
              >
                Learn more
              </Link>
            </div>
          ...
          {/* Right 3D Interactive Element - DON'T CHANGE */}
          <div className="h-[500px] bg-gradient-to-br from-blue-50 to-gray-50 rounded-2xl flex items-center justify-center overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div className="text-center">
              <div className="text-5xl font-normal text-[#4285F4] mb-4">20K+</div>
              <p className="text-gray-600 text-base">Evaluations per user</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-normal text-[#4285F4] mb-4">&lt;50ms</div>
              <p className="text-gray-600 text-base">Query response time</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-normal text-[#4285F4] mb-4">100%</div>
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-md hover:border-[#4285F4] transition">
            <div className="w-14 h-14 rounded-lg bg-[#E8F0FE] flex items-center justify-center text-2xl mb-5">
              🔐
            </div>
            <h3 className="text-xl font-medium text-gray-900 mb-3">Multi-Tenant Secure</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-md hover:border-[#4285F4] transition">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Flexible Policies</h3>
            <p className="text-gray-600 text-base leading-relaxed">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-md hover:border-[#4285F4] transition">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">PII Protection</h3>
            <p className="text-gray-600 text-base leading-relaxed">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-md hover:border-[#4285F4] transition">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Live Dashboards</h3>
            <p className="text-gray-600 text-base leading-relaxed">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-md hover:border-[#4285F4] transition">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Lightning Fast</h3>
            <p className="text-gray-600 text-base leading-relaxed">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-md hover:border-[#4285F4] transition">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">REST API</h3>
            <p className="text-gray-600 text-base leading-relaxed">
          ...
          <div className="space-y-16">
            ...
            <div className="flex gap-8 items-start">
              ...
              <div className="flex-grow pt-1">
                <h3 className="text-2xl font-medium text-gray-900 mb-3">Configure Your Policy</h3>
                <p className="text-gray-600 text-base leading-relaxed">
            ...
            <div className="flex gap-8 items-start">
              ...
              <div className="flex-grow pt-1">
                <h3 className="text-2xl font-medium text-gray-900 mb-3">Ingest Evaluations</h3>
                <p className="text-gray-600 text-base leading-relaxed">
            ...
            <div className="flex gap-8 items-start">
              ...
              <div className="flex-grow pt-1">
                <h3 className="text-2xl font-medium text-gray-900 mb-3">View Analytics</h3>
                <p className="text-gray-600 text-base leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <h2 className="text-3xl font-normal text-gray-900 mb-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition">
            <h3 className="text-xl font-medium text-gray-900 mb-1">Starter</h3>
          ...
          {/* Pro Tier */}
          <div className="bg-white border-2 border-[#4285F4] rounded-lg p-6 shadow-md">
            <div className="bg-[#4285F4] text-white px-3 py-1 rounded text-xs font-medium inline-block mb-3">
              RECOMMENDED
            </div>
            <h3 className="text-xl font-medium text-gray-900 mb-1">Professional</h3>
            <p className="text-gray-600 text-sm mb-4">For growing teams</p>
            <div className="mb-6">
              <span className="text-4xl font-normal text-gray-900">$29</span>
              <span className="text-gray-600 text-sm">/month</span>
            </div>
            <ul className="space-y-3 mb-6">
              <li className="flex gap-2">
          ...
          {/* Enterprise Tier */}
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition">
            <h3 className="text-xl font-medium text-gray-900 mb-1">Enterprise</h3>
            <p className="text-gray-600 text-sm mb-4">For large-scale deployments</p>
            <div className="mb-6">
              <span className="text-4xl font-normal text-gray-900">Custom</span>
            </div>
            <ul className="space-y-3 mb-6">
              <li className="flex gap-2">
                <span className="text-[#4285F4] font-medium">✓</span>
      ...
      <section className="bg-[#4285F4] py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <Link
            href="/auth/signup"
            className="inline-block px-8 py-3 bg-white text-[#4285F4] rounded-lg hover:bg-gray-50 font-medium text-sm transition shadow-md"
          >
            Start free today
          </Link>
        </div>
